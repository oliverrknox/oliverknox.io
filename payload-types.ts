...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'experience-card': ExperienceCardSelect<false> | ExperienceCardSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "experience-card".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'experience-card';
        value: string | ExperienceCard;
      } | null)
    | ({
        relationTo: 'users';
        value: string | User;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "experience-card_select".
 */
export interface ExperienceCardSelect<T extends boolean = true> {
  placeOfWork?: T;
  role?: T;
  startDate?: T;
  endDate?: T;
